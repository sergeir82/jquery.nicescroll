...
(function(factory) {
   ...
   * @param {Array} forOmit blacklisted array of keys.
   * @return {{}} Result object without omit
   */
  var omit = function (source, forOmit) {
    forOmit = forOmit || [];
          ...
          if (cap.cantouch || self.istouchcapable || self.opt.touchbehavior || cap.hasmstouch) {
            ...
            self.ontouchmove = function(e, byiframe) {
              ...
              if (self.rail.drag.pt == 2) {
                ...
                var ev = omit(e, [ 'webkitMovementX', 'webkitMovementY' ]);
                ev.original = e;
